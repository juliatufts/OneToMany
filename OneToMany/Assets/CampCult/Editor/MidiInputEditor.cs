...
class MidiInputEditor : Editor
{
    public override void OnInspectorGUI ()
    {
        ...
        midi.sensibilitySlow = EditorGUILayout.Slider ("Camp Sensibility (slow)", midi.sensibilitySlow, 1.0f, 25.0f);
        midi.sensibilityFast = EditorGUILayout.Slider ("Camp Sensibility (fast)", midi.sensibilityFast, 1.0f, 25.0f);
